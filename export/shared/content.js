...
window.PORTFOLIO = {
  identity: {
    ...
    linkedin: "linkedin.com/in/misha",
    github: "github.com/misha",
    pronouns: "she/her",
  ...
  about: {
    ...
    project: "Project ATLAS — a self-service portal for model registration, deployment approvals, and post-deployment drift monitoring. Replaces a 1,200-line spreadsheet and a Jira workflow that took 11 days end-to-end.",
  },

  ksa: {
    knowledge: [
      { name: "Full-stack web architecture", level: 4, note: "React 18, FastAPI, PostgreSQL, Redis. Built five end-to-end features." },
      { name: "MLOps lifecycle", level: 3, note: "Model registry, CI/CD for models, canary rollouts, drift detection." },
      { name: "Cloud + Containers", level: 3, note: "Kubernetes, Helm, AWS (EKS, S3, SageMaker), Terraform basics." },
      { name: "Data governance & risk", level: 2, note: "MAS TRM guidelines, model risk management, audit trails." },
      { name: "Observability", level: 3, note: "Prometheus, Grafana, OpenTelemetry — built three custom dashboards." },
    ],
    skills: [
      { name: "TypeScript / React", level: 4 },
      { name: "Python / FastAPI", level: 4 },
      { name: "Kubernetes / Helm", level: 3 },
      ...
      { name: "Terraform / IaC", level: 2 },
    ],
    attitudes: [
      { name: "Ownership", note: "Took the drift-alerts feature from spec to prod with one mentor check-in per week." },
      { name: "Communication", note: "Wrote three RFCs read by ~14 engineers; ran two cross-team demos." },
      { name: "Curiosity", note: "Self-studied MAS TRM section 6 to argue for tighter audit logs." },
      { name: "Resilience", note: "Survived the great K8s upgrade incident of week 9 with no production downtime." },
      { name: "Collaboration", note: "Paired with two senior MLEs on model-registry schema migration." },
    ],
  },
