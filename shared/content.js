...
window.PORTFOLIO = {
  ...
  about: {
    ...
    project: "Project MMP — a self-service portal for model registration, deployment approvals, and built-in drift detection that blocks runs and alerts project owners when input distributions shift.",
  },
  ...
  tsc: [
    { code: "ICT-DEV-3001", name: "Software Design", level: 3, evidence: "MMP approval-pipeline redesign, 2 production releases" },
  ...
  ccs: [
    ...
    { name: "Self-Management", level: "Advanced", task: "Drove the drift-detection refactor and release integration while coordinating directly with the AVP of GDO AI Platforms." },
  ...
  artifacts: [
    {
      ...
      summary: "Internal AI governance platform for model registration, risk review, and deployment approvals. Collaborated with the full-stack team to ship 2 production releases, each spanning end-to-end features, new API routes, and changes to the approval pipeline.",
      contribution: "Embedded with the full-stack team across both releases — contributed to the React frontend, new FastAPI endpoints, and approval-pipeline logic. Touched everything from UI components to database migrations.",
      impact: "Both releases shipped to production on schedule. Approval workflow adopted by model-owner teams across the division.",
      proof: ["2 production releases shipped", "RFC-027", "Demo: internal Loom (link in handover)"],
    },
    {
      id: "drift-alerts",
      title: "Drift Detection — built into MMP",
      kind: "AI governance · MLOps",
      stack: ["Python", "FastAPI", "React", "PostgreSQL"],
      summary: "Drift detection integrated directly into MMP: if input-distribution drift is detected on a model, the platform automatically disables the run and alerts the project owner with a breakdown of what changed and why it was blocked.",
      contribution: "Refactored the existing detection code for performance and reliability, then worked with the team — including the Assistant Vice President of GDO AI Platforms — to include the feature in a production MMP release end-to-end.",
      impact: "Drift-gated runs are now enforced platform-wide. Project owners receive targeted alerts explaining the specific change, reducing time spent investigating blocked runs.",
      proof: ["Shipped in MMP production release", "Worked directly with AVP, GDO AI Platforms"],
    },
    {
      id: "audit-logs",
      ...
      summary: "RFC for tamper-evident audit logging on all MMP write paths, aligned with MAS TRM section 6.",
      ...
      impact: "Adopted in MMP v1.4. Cited in two subsequent platform RFCs.",
  ...
  timeline: [
    ...
    { week: "W3–4", phase: "First feature", title: "MMP — first production release", note: "Embedded with the full-stack team. Contributed end-to-end: React components, new API routes, and approval-pipeline changes. First time touching a live governance platform in production." },
    ...
    { week: "W10–12", phase: "Optimisation", title: "Drift detection — refactor & integration", note: "Refactored the drift detection code for performance and reliability. Worked directly with the AVP of GDO AI Platforms to scope what the production integration needed to look like." },
    { week: "W13–14", phase: "Production", title: "Drift detection ships in MMP release", note: "Feature included in a production MMP release. Drift-gated runs now enforced platform-wide; project owners alerted with a breakdown of what changed and why the run was blocked." },
  ...
  outlook: {
    ...
    accomplishments: "Drift detection shipped in a production MMP release — project owners now get a clear explanation of what changed and why their run was blocked. Two MMP production releases contributed to with the full-stack team. One RFC adopted. The accomplishment I'm proudest of is earning enough trust to work directly with the AVP on a production feature.",
